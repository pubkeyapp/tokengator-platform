...
export function UserProjectMemberUiTable({
  deleteProjectMember,
  projectMembers = [],
  onPageChange,
  page,
  ...
  deleteProjectMember: (projectMember: ProjectMember) => void
          ...
          },
          {
            ...
            render: (item) => (
              <Group gap="xs" justify="right">
                ...
                <ActionIcon color="red" variant="light" size="sm" onClick={() => deleteProjectMember(item)}>
                  <IconTrash size={16} />
                </ActionIcon>
              </Group>
            ),
